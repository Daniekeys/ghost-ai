...
1. Add resizing. 
 ...
 - keep editing smooth without causing layou shifts 
 -show a textarea directly over the label without editing 
...
- textarea is shows directly over the label without editing. 
