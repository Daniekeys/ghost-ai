...
3. When dragging a shape, imclude the shape name and default size in the drag payload. 
...
- New nodes uses the custom canvas node type. 
- `npm run build` passes without any type  error. 